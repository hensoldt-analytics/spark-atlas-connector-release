...
class SparkExecutionPlanProcessorForViewSuite
  ...
  // FIXME: it doesn't seem to work with Spark 2.3 - let's revisit it when we really need to fix
  ignore("CREATE TEMPORARY VIEW FROM TABLE, SAVE TEMP VIEW TO TABLE") {
